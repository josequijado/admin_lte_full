        ...
        <div class="container-fluid">
                ...
                <div class="row">
                        ...
                        <div class="card card-widget widget-user-2">
                            ...
                            <div class="widget-user-header bg-warning">
                                <div class="widget-user-image">
                                    <img class="img-circle elevation-2" src="{{ asset('lte/dist/img/user7-128x128.jpg') }}" alt="User Avatar">
                                </div>
                                {{-- /.widget-user-image --}}
                    ...
                    {{-- /.col --}}
                        <div class="col-md-4">
                            ...
                            <div class="card card-widget widget-user">
                                {{-- Add the bg color to the header using any of the bg-* classes --}}
                                <div class="widget-user-header text-white" style="background: url('{{ asset('lte/dist/img/photo1.png') }}') center center;">
                                    <h3 class="widget-user-username text-right">Elizabeth Pierce</h3>
                                    <h5 class="widget-user-desc text-right">Web Designer</h5>
                                </div>
                                <div class="widget-user-image">
                                    <img class="img-circle" src="{{ asset('lte/dist/img/user3-128x128.jpg') }}" alt="User Avatar">
                                </div>
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-sm-4 border-right">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    {{-- /.card-header --}}
                    <div class="card-body">
                        <img class="img-fluid pad" src="{{ asset('lte/dist/img/photo2.png') }}" alt="Photo">
                    ...
                    <div class="card-footer card-comments">
                        ...
                        <div class="card-comment">
                        {{-- User image --}}
                            <img class="img-circle img-sm" src="{{ asset('lte/dist/img/user4-128x128.jpg') }}" alt="User Image">
                            <div class="comment-text">
                                <span class="username">
                                    Luna Stark
                                    <span class="text-muted float-right">8:03 PM Today</span>
                    ...
                    <div class="card-footer">
                        <form action="#" method="post">
                            @csrf
                            <img class="img-fluid img-circle img-sm" src="{{ asset('lte/dist/img/user4-128x128.jpg') }}" alt="Alt Text">

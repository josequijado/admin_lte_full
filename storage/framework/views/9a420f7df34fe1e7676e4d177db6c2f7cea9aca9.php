<nav class="main-header navbar navbar-expand-md navbar-light navbar-white" id="topnav-wide" style="display:none;">
    <div class="container">
        <a href="#" class="navbar-brand menu_link" data-page="" data-group="" data-subgroup="SB_01_01">
        ...
        <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
                <li class="nav-item" id="sidebar-button">
...
<?php /**PATH C:\laragon\www\laravel_base\resources\views/admin/commons/topnav-wide.blade.php ENDPATH**/ ?>